    ...
    >
      <ul className=" -space-x-px text-sm flex-wrap hidden md:inline-flex">
        <Link
          ...
          className="flex justify-center items-center px-4 cursor-pointer  text-blue-400"
        >
          {'<'}
        </Link>
      ...
      <div className="flex flex-col w-full items-center justify-center">
        ...
        <span className="px-4 py-2 text-sm text-gray-700 dark:text-gray-400">
          ...
          {currentPage !== 1 && 'desde'} {currentPage}{' '}
          {(currentPage !== totalPage && !!totalPage) ?? 'de'}{' '}
          <Link className="text-blue-500" href={`/blog/all/?page=${totalPage}`}>
